  ...
  <div class="content-wrapper"> 
   <!--  <section class="content-header">
    ...
    <div class="text-center">
   		 <img src="dist/img/estimote.png" width="100px" />
    </div>
  <h3 class="text-center text-uppercase mb20">Estimote Login</h3>
  <!-- /.login-logo -->
  <div class="login-box-body" >
    <form  action="estimote" method="post" class="panel-body" style=" padding-top: 16px;">
      <div class="form-group has-feedback">
        <input type="email" name="email" class="form-control" placeholder="Enter Beacon Id" id="email"  >
        <span class="glyphicon glyphicon-envelope form-control-feedback glyphiconcolor"  style="color: #068ad6"></span>
      </div>
     <div class="form-group has-feedback" >
        <input type="password" name="password" class="form-control" placeholder="Enter Beacon API Password" id="password" required>
        <span class="glyphicon glyphicon-lock form-control-feedback glyphiconcolor" style="color: #068ad6"></span>
      </div>
      <div class="row">
        <!-- /.col -->
        <div class="col-xs-12">
          <button type="submit" id="submit" class="btn btn-primary btn-block btn-flat">Associate</button>
          <p>${msg}</p>
        </div>
        <!-- /.col -->
      </div>
