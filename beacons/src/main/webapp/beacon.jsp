      ...
      <div class="row">
        <div class="col-xs-12">
         <div class="clearfix mb20">
          ...
          <div class="col-sm-9 pr text-right"><a href="" class="btn btn-primary">Add Beacon</a></div>
         </div>
          <div class="panel">
            <!-- /.box-header -->
            <div class="panel-body">
            <i class="fa fa fa-signal fa-3x pull-left"></i>
            <p class="text-left col-sm-6 mb0"> You don't have any beacons configured for Here & Now yet.
				Add some beacons to get started.
            </p>
            <a href="" class="btn btn-info pull-right">Add Beacon</a>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
