...
<title>Estimote Associate | Ciweb</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
     ...
     <!--   <li class="treeview"> <a href="index"> <i class="fa fa-dashboard"></i> <span></span> </a> </li> -->
            ...
            <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span>
           	<ul class="treeview-menu">
            	<!-- <li><a href="estimote.jsp"><i class="fa fa-circle-o"></i> Estimote</a></li> -->
            	 ...
            	 <li><a href="eAssociate.jsp"><i class="fa fa-circle-o"></i> eAssociate</a></li> 
 ...
 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper"> 
    ...
    <div class="text-center">
  	...
  	<h3 class="text-center text-uppercase mb20">Estimote Assocaited</h3>
  	</section>
	</div>
  </div>
  <!-- /.box -->
...
<script type="text/javascript">
	var init = function() {
	    ...
	    if(email === "null") {
	    	...
	    	if (email != "null") {
	    	i=false;
	    	window.location.href="eAssociate.jsp";
	    	}
	    }
	    init = true;
	};
