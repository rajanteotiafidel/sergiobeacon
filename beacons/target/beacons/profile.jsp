						...
						<form role="form" method="post" action="profile">
							...
							<p>${msg}</p>
								...
								<div class="form-group has-feedback  clearfix">
									...
									<span class="fa fa-building-o form-control-feedback" style="color: #068ad6;" aria-hidden="true" ></span>
								</div>
									<div class="form-group  has-feedback clearfix">
							...
							<div class="box-footer">
								<button type="submit" class="btn btn-primary" style="float:right;" id="submit" name="submit">Submit</button>
							</div>
						</form>
					</div>
					<!-- /.box -->
