...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1> Nearables <small></small> </h1>
      <ol class="breadcrumb">
        <li><a href="index"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Nearables</li>
      </ol>
    </section>
      ...
      <div class="row">
        <div class="col-xs-12">
         <div class="clearfix mb20">
          <div class="col-sm-3"><div class=""><input type="checkbox" style="margin-right:10px;" />
          <button type="button" class="btn btn-primary" disabled="">Transfer</button>
          </div>
         </div>
          <div class="col-sm-9 pr text-right"><a href="" class="btn btn-primary">Buy Estimote Stickers</a></div>
         </div>
          <div class="panel">
            <!-- /.box-header -->
            <div class="panel-body">
            <p class="text-left col-sm-6 mb0">
            It seems you don't have any Estimote Stickers registered in Cloud. 
            Please contact our Support Team if you feel this is wrong or purchase stickers. Contact Support
            </p>
            <a href="" class="btn btn-info pull-right">Contact Support</a>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
